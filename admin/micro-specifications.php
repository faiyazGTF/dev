			...
			<div class="microbox">
				...
				<div class="box-two">
					...
					<div class="input-sec custom_input_sec">
						<textarea class="form-control myeditor" name="descriptions"id="descriptions" placeholder="Descriptions" ></textarea>
                        ...
                        <div class="modal-body">
							<form action="" id="updateothermicrodata">
								...
								<div class="form-group">
									...
									<textarea name="updatedescriptions" class="form-control myeditor1" id="updatedescriptions" cols="30" rows="10"></textarea>
								</div>
