<?php 
	...
	if(isset($_GET['id'])){
		...
		if(mysqli_num_rows($map_query) > 0){
			...
			$descriptions = $map_row['descriptions'];
		}


		$checksections = mysqli_query($conn, "SELECT * FROM `micro_sections` WHERE micro_id=".$eid." AND section_type=5");
			...
			<div class="col-md-12">
				...
				<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="hidden" name="section_type" value="<?= encryptor('encrypt',5) ?>">
				...
				<div class="left-area">
					<div class="microbox">
						...
						<div class="box-two">
							...
							<div class="input-sec-multi">
								<textarea type="text" class="form-control" placeholder="some Url Here"  id="location_iframe"><?php echo $old_iframe; ?></textarea>
