<!--------------- Testimonials Section Codes End From Here  ----------------->
            ...
            <div class="col-sm-12 col-md-3 col-lg-3 fourth_col">
                ...
                <ul>
                 ...
                 <div class="rera_certificate">
                            <a href="<?= BASE_URL ?>assets/images/up-rera.pdf" target="_blank">
                                <img src="<?= BASE_URL ?>assets/images/up-rera.jpg" alt="up rera" class="img-fluid">
                            </a>
                            <a href="<?= BASE_URL ?>assets/images/delhi-rera.pdf" target="_blank">
                                <img src="<?= BASE_URL ?>assets/images/delhi-rera.jpg" alt="delhi rera" class="img-fluid">
                            </a>
                        </div>
                </ul>
            </div>   
