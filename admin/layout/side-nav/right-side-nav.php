<section class="right-side right-sidenav">
	<div class="sidenav right">
		...
		<a href="banner.php?id=<?php echo $update_id ?>">
			<div class="nav <?= ($activePage == 'banner') ? 'active':''; ?>"><div class="icon"><img src="images/icon/banner.png"></div><div class="description">Banner</div>
			</div>
		</a>
		...
		<a href="micro-site-gallery.php?id=<?php echo $update_id ?>">
			<div class="nav <?= ($activePage == 'micro-site-gallery') ? 'active':''; ?>"><div class="icon"><img src="images/icon/banner.png"> </div><div class="description">Gallery</div></div>
		</a>
		<a href="price-list.php?id=<?php echo $update_id ?>">
			<div class="nav <?= ($activePage == 'price-list') ? 'active':''; ?>"><div class="icon"><img src="images/icon/rupee-indian.png"> </div><div class="description">Price List</div></div>
		</a>
	</div>
</section>