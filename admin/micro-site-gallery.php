<?php 
	...
	if(isset($_GET['id'])){
		...
		$checksections = mysqli_query($conn, "SELECT * FROM `micro_sections` WHERE micro_id=".$eid." AND section_type=7");
		...
		<form action="" id="addmmicrosections">
				...
				<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="hidden" name="section_type" value="<?= encryptor('encrypt',7) ?>">
    ...
    <div class="col-md-6">
	 ...
	 <div class="microbox">
		...
		<div class="box">
            ...
            <div class="input-sec-multi">
            <input type="text" class="form-control-file form-control" id="imagealt" name="imagealt">
...
<div class="modal fade zoomIn" id="updaemicrobanners" tabindex="-1" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            ...
            <div class="input-sec-multi">
            <input type="text" class="form-control-file form-control" id="imagealtupdate" name="imagealt">
