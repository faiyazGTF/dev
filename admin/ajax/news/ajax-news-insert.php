<?php 
	...
	$location = "../../uploads/news/$desktop_newName";
	...
	$location1 = "../../uploads/news/$mobile_newName";
...
$result = mysqli_query($conn,"INSERT INTO news(meta_title,meta_keywords,meta_description,heading,large_image,mobile_image,shortDesc,description,blogDate) VALUES('$metatitle','$metakey','$metadesc','$heading','$desktop_newName','$mobile_newName','$shortDesc','$description','$date')");

if($result==1){
    echo json_encode(['status'=>1,'message'=>"News Added Sucessfully"]);
}
}else{
