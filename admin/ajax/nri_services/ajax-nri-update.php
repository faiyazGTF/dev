<?php 
    ...
    if(!empty($_FILES['desktop_image']['name'])){
        ...
        $location = "../../uploads/nri_services/$old_desktop_image";
    ...
    if(!empty($_FILES['mobile_image']['name'])){
        ...
        $location1 = "../../uploads/nri_services/$old_mobile_image";
    ...
    $sql = "UPDATE nri_service SET meta_title='$metatitle',meta_keywords='$metakey',meta_description='$metadesc',heading='$heading', shortDesc='$shortDesc', description='$description', blogDate='$date' $sqrstr WHERE id='$id'";
