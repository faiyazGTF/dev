...
<form action="" id="uploadblodtsdata">
  ...
  <div class="microbox">
    <div class="head-box">
      <h6><i class="fa fa-building" aria-hidden="true"></i> Add News</h6>
    </div>
...
$.ajax({
  url:'ajax/news/ajax-news-edit.php',
  type:'post',
...
function editBlog(id){
  ...
  $(".loader-icon-head").css('display', 'flex');
  $.ajax({
    url:'ajax/news/ajax-edit-show-news.php',
    type:'post',
    data:{'id':id},
    success:function(data){
      var jsonData = JSON.parse(data)
...
function deleteBlog(id){
  $(".loader-icon-head").css('display', 'flex');
  $.ajax({
    url:'ajax/news/ajax-news-delete.php',
    type:'post',
    data: {'id':id},
    success:function(data){
      console.log(data)
...
$.ajax({
  url:'ajax/news/ajax-news-insert.php',
  type: "POST",
  data: formData,
  dataType: 'json',
  contentType: false,
...
$.ajax({
  url:'ajax/news/ajax-news-update.php',
  type:'post',
  data:fd,
  contentType:false,
  processData:false,
