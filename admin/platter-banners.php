		...
		<div class="">
			<div class="microbox">
				...
				<div class="box-two">
					...
					<div class="input-sec-multi">
						<input type="file" class="form-control-file form-control" id="mobilebannes" name="mobilebannes">
			...
			<div class="inner-table">
				<table class="table">
					<thead>
						<tr>
							<th>Sr. No.</th>
							<th>Descktop Banners</th>
							<th>Mobile Banners</th>
					...
					<?php  
						$allbanenrq = mysqli_query($conn, "SELECT * FROM `platter_site_banner` WHERE project_id=".$eid."");
							if($allbanenrq->num_rows >0){
								...
								while ($data=mysqli_fetch_assoc($allbanenrq)) {
										...
										<td><select class="form-control" style="width:100px;" onchange="updatesignlerecord(`platter_site_banner`,`status`,`'.encryptor('encrypt', $data['id']).'`,this.value)">
                        ...
                        <div class="modal-body">
							<form action="" id="updatebanenrform">
								...
								<div class="form-group">
									...
									<input type="file" name="upddatefilemobile" id="upddatefilemobile" class="form-control">
								</div>
...
<script src="vendor/platter-banners.js"></script>
