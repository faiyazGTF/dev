			...
			<div class="right-area">
				...
				<!---------box---------->
					...
					<div class="box">
					  ...
					  <div class="input-sec custom_input_sec">
						<select class="form-control" onchange="Project_stateaddpage(this.value)" name="project_state" id="project_state">
					...
					<input type="hidden" class="form-control" value="<?php echo $price; ?>" name="project_price" id="project_price" placeholder="">
					<div class="box-two">
						<div class="admin-text">
						  <span>Project RERA:</span>
						</div>
						<div class="input-sec custom_input_sec">
						<input type="text" class="form-control" value="" name="project_rera_no" id="project_rera_no" placeholder="Enter Project RERA" name="">
					...
					<div class="box-two d-none">
						...
						<div class="input-sec custom_input_sec">
						<input type="text" class="form-control" value="" name="agent_rera" id="agent_rera" placeholder="Enter Agent RERA" name="">
					...
					<div class="box">
						...
						<div class="input-sec custom_input_sec">
							<input type="text" class="form-control" value="" name="starting_price" id="starting_price" placeholder="Starting Price">
