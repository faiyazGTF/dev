				...
				<div class="col-md-12">
					<div class="microbox">
						...
						<div class="box">
							...
							<div class="input-sec custom_input_sec">
								<input type="text" class="form-control" value="<?php echo $row['meta_keywords']; ?>" name="ServiceMetaKeyword" id="ServiceMetaKeyword" placeholder="Title Here">
								<!--<i class="fa fa-times" aria-hidden="true"></i>-->
							</div>
						</div><!---------box---------->
						<div class="box">
							...
							<div class="input-sec custom_input_sec">
								<input type="text" class="form-control" value="<?php echo $row['meta_description']; ?>" name="ServiceMetadescription" id="ServiceMetadescription" placeholder="Title Here">
								<!--<i class="fa fa-times" aria-hidden="true"></i>-->
							</div>
						</div><!---------box---------->
					</div>
