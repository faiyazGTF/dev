...
<form action="" id="uploadblodtsdata">
  ...
  <div class="microbox">
    <div class="head-box">
      <h6><i class="fa fa-building" aria-hidden="true"></i> Add NRI Service</h6>
    </div>
...
<br><br>
    ...
    <div class="col-md-12">
            <div class="microbox">
        <div class="head-box">
          <h6><i class="fa fa-building" aria-hidden="true"></i> Edit News</h6>
        </div>
...
$.ajax({
  url:'ajax/nri_services/ajax-nri-edit.php',
  type:'post',
...
function editBlog(id){
  ...
  $(".loader-icon-head").css('display', 'flex');
  $.ajax({
    url:'ajax/nri_services/ajax-edit-show-nri.php',
    type:'post',
    data:{'id':id},
    success:function(data){
      var jsonData = JSON.parse(data)
...
function deleteBlog(id){
  $(".loader-icon-head").css('display', 'flex');
  $.ajax({
    url:'ajax/nri_services/ajax-nri-delete.php',
    type:'post',
    data: {'id':id},
    success:function(data){
      console.log(data)
...
$.ajax({
  url:'ajax/nri_services/ajax-nri-insert.php',
  type: "POST",
  data: formData,
  dataType: 'json',
  contentType: false,
...
$.ajax({
  url:'ajax/nri_services/ajax-nri-update.php',
  type:'post',
  data:fd,
  contentType:false,
  processData:false,
  success:function(data){
    alert("NRI Service Updated");
