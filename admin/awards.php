...
<div class="inner-micro-structure">
    <div class="left-area">
      ...
      <div class="microbox">
        <div class="head-box">
          <h6><i class="fa fa-building" aria-hidden="true"></i> Add Awards gallery</h6>
        </div>
        <div class="box-two">
        ...
        <div class="box-two">
            ...
            <div class="input-sec-multi">
            <input type="text" class="form-control" placeholder="some text here" id="subheading">
            <div class="text-danger" id="subheading_err"></div>
            </div>
        </div><!-------------box-2-------->
        <div class="box-two">
            <div class="admin-text">
            ...
            <div class="input-sec-multi">
            <input type="file" class="form-control-file form-control" id="images">
        ...
        <div class="box-two d-none">
            ...
            <div class="input-sec-multi">
            <input type="file" class="form-control-file form-control" id="videos">
    ...
    <div class="right-area">
            <div class="microbox">
        <div class="head-box">
          <h6><i class="fa fa-building" aria-hidden="true"></i> Edit Awards Gallery</h6>
        </div>
...
function showDetails(){
  ...
  $.ajax({
    url:'ajax/awards/ajax-awards-show.php',
    type:'post',
...
function editworkculture(id){
  ...
  $(".loader-icon-head").css('display', 'flex');
  $.ajax({
    url:'ajax/awards/ajax-awards-edit.php',
    type:'post',
    data:{'id':id},
    success:function(data){
      // console.log(data)
...
function deleteworkculture(id){
  $(".loader-icon-head").css('display', 'flex');
  $.ajax({
    url:'ajax/awards/ajax-awards-delete.php',
    type:'post',
    data:{'id':id},
    success:function(data){
      $('#heading').val('')
...
if(subheading == ''){
  $('#subheading_err').html('Field Required')
  flag = false
}else{
  $('#subheading_err').html('')
}
...
if(flag){
  ...
  $(".loader-icon-head").css('display', 'flex');
  $.ajax({
    url:'ajax/awards/ajax-awards-insert.php',
    type:'post',
    data:fd,
    contentType:false,
    processData:false,
...
$(".loader-icon-head").css('display', 'flex');
$.ajax({
  url:'ajax/awards/ajax-awards-update.php',
  type:'post',
  data:fd,
  contentType:false,
  processData:false,
