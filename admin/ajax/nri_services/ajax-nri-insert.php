<?php 
	...
	$desktop_newName = 'nri-l'.$rand.'.'.$extension;

	$location = "../../uploads/nri_services/$desktop_newName";
	...
	// $mobile_newName = 'nri-m'.$rand1.'.'.$extension;

	// $location1 = "../../uploads/nri_services/$mobile_newName";
...
$result = mysqli_query($conn,"INSERT INTO nri_service(meta_title,meta_keywords,meta_description,heading,large_image,mobile_image,shortDesc,description,blogDate) VALUES('$metatitle','$metakey','$metadesc','$heading','$desktop_newName','$mobile_newName','$shortDesc','$description','$date')");

if($result==1){
    echo json_encode(['status'=>1,'message'=>"NRI Services Added Sucessfully"]);
}
}else{
